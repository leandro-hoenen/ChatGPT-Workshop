...
# student1_email = ENV["SEED_STUDENT_1_EMAIL"]
# student1_password = ENV["SEED_STUDENT_1_PASSWORD"]
# student2_email = ENV["SEED_STUDENT_2_EMAIL"]
# student2_password = ENV["SEED_STUDENT_2_PASSWORD"]
# lecturer1_email = ENV["SEED_LECTURER_1_EMAIL"]
# lecturer1_password = ENV["SEED_LECTURER_1_PASSWORD"]

# # Registration keys
# student_key = ENV['STUDENT_KEY']
# lecturer_key = ENV['LECTURER_KEY']

# puts ENV["POSTGRES_USER"]

# # Create Users
# users = [
#   { email: student1_email, password: student1_password, role: 0, registration_key: student_key },
#   { email: student2_email, password: student2_password, role: 0, registration_key: student_key },
#   { email: lecturer1_email, password: lecturer1_password, role: 1, registration_key: lecturer_key },
# ]
...
#     user: User.find_by(email: student1_email)
#   },
#   {
...
#     user: User.find_by(email: student2_email)
#   },
#   {
